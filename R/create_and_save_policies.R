...
#'
#' Given the input argument creates a sort of grid array, i.e all permutations, version of an environment
#' which behaves like a list object.
#'
#' @param incidence_list WHO incidence in country of origin groups to target screening
#' @param endpoints when to stop using costs and QALYs at time of exit or death
#' @param LTBI_test TSPOT or QFT
#' @param treatment 6 months or 3 months LTBI regimens
#'
